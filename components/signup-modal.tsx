...
export const SignupModal = ({ onClose, onLoginClick }: SignupModalProps) => {
        ...
        <div className="relative">
          ...
          <div className="relative bg-black/90 backdrop-blur-xl rounded-xl overflow-hidden border border-purple-900/50 p-6">
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-purple-300 text-sm mt-1">Join NEON PULSE and discover new music</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center text-sm text-purple-300">
                ...
                <Button variant="link" className="text-pink-400 hover:text-pink-300 p-0" onClick={onLoginClick}>
                  Log in
                </Button>
              </div>
            </form>
